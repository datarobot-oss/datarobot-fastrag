...
async def llm_blueprint_score(
    ...
    for idx, query in enumerate(data[prompt_column_name].tolist()):
        ...
        language_model_result, docs, query_emb = await submit_llm_blueprint_prompt(
...
async def llm_blueprint_chat(
    ...
    return await generate_llm_blueprint_chat_completion(
