...
class CustomModelRuntimeParameters(StrEnum):
    ...
    def do_not_override_parameters(cls) -> set[str]:
        ...
        """
        return {
            cls.VECTOR_DATABASE_ID.value,
            cls.VECTOR_DATABASE_FAMILY_ID.value,
            cls.VECTOR_DATABASE_DEPLOYMENT_ID.value,
            cls.LLM_BLUEPRINT_ID.value,
            cls.LLM_TEST_SUITE_ID.value,
            cls.LLM_ID.value,
            cls.PLAYGROUND_ID.value,
        }
